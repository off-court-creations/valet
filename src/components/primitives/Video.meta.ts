...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: [
      'Marketing or educational clips within content',
      'Short previews that benefit from poster images and preload control',
    ],
    whenNotToUse: [
      'Static imagery (use Image)',
      'Heavy decorative backgrounds (consider ParallaxBackground or CSS background video carefully)',
    ],
