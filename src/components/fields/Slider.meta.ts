...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: [
      'Volume, brightness, rating, or bounded numeric inputs',
      'When relative, approximate selection is acceptable',
    ],
    whenNotToUse: [
      'Exact values that require precision (use a numeric TextField)',
      'Categorical choices (use Radio or Select)',
    ],
