...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: [
      'Primary and secondary actions in forms and panels',
      'Navigation that behaves like a button (otherwise use a link)',
      'Include icons to reinforce meaning or save space',
    ],
    whenNotToUse: [
      'Icon‑only actions (use IconButton)',
      'Inline text links for navigation (use anchor elements)',
    ],
