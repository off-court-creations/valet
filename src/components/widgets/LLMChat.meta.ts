...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: [
      'Chat experiences with streaming replies and turn history',
      'Lightweight sandbox for model prompts and responses',
    ],
    whenNotToUse: [
      'Rich, tool‑augmented transcripts (use RichChat)',
      'Static logs or read‑only transcripts (use Markdown/Panel)',
    ],
