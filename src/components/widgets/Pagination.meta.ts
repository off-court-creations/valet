...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: [
      'Tables or lists with many items where pages are preferable to infinite scroll',
      'Search results or archives where page position matters',
    ],
    whenNotToUse: [
      'Continuous feeds where infinite scroll is a better fit',
      'Small collections that fit on a single page',
    ],
