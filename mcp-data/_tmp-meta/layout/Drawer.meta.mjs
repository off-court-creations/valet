...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: ['Secondary navigation, filters, or details alongside primary content', 'Responsive navigation that collapses on small screens', 'Non‑blocking utilities that can be dismissed'],
