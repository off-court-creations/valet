...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: ['Forms that require free‑form or constrained text', 'Search bars, filters, and settings', 'Use multiline for longer text, or type=password/number/email where appropriate'],
    whenNotToUse: ['Binary choices (use Switch or Checkbox)', 'Small enumerations (use Radio or Select)'],
