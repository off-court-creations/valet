...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: ['Tag pickers, filters, and quick toggles where visibility matters', 'Small to medium sets where chips communicate state effectively'],
    whenNotToUse: ['Long option lists (use Select)', 'Exactly one choice when radio clarity is preferred (use Radio)'],
