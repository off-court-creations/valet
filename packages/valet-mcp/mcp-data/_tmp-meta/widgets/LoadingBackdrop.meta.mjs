...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: ['Block interactions during critical loads or transitions', 'Ensure a11y focus management while disabling the underlying UI'],
    whenNotToUse: ['Inline/section‑level loading (use Progress)', 'Skeletonable content where layout should remain visible (use Skeleton)'],
