...
export default defineComponentMeta({
  ...
  usage: {
    ...
    whenToUse: ['Segment a page into readable sections', 'Show a list/grid of cards with consistent styling', 'Visually elevate important content without creating a new page'],
