...
- [x] **Checkbox** _(stable 2026-06-17 — REDONE colors/mobile/sizing per [checkbox-redo](checkbox-redo-2026-06-17.md); both gates)_ (before Select/Table) · [x] **Switch** _(stable 2026-06-17 — both gates; mobile hardened: chrome kit + ≥44px coarse-pointer hit target)_ · [ ] Slider · [ ] TextField
