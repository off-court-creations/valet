...
import { Surface, Stack, Typography, Button, Tabs, Icon, useTheme, Box } from '@archway/valet';
...
export default function TabsDemoPage() {
  ...
  /* Reference table removed; using ReferenceSection in docs */
    ...
    <Surface>
      ...
      <Stack>
        ...
        <Tabs>
          ...
          <Tabs.Panel>
            <ReferenceSection slug='components/layout/tabs' />
          </Tabs.Panel>
        </Tabs>
